        ...
        implements ConnectorMetadata
{
    ...
    {
        TpchTableHandle tableHandle = Types.checkType(table, TpchTableHandle.class, "table");
    ...
    {
        TpchTableLayoutHandle layout = Types.checkType(handle, TpchTableLayoutHandle.class, "layout");
